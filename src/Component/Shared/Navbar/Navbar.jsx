...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar fixed z-20 bg-opacity-60  bg-black shadow-lg  text-white mx-w-full">
                <div className="navbar-start">
                    ...
                    <div  className="flex justify-between items-center gap-2 text-xl">  <img className="w-[40px] h-[40px] rounded-full" src="https://i.postimg.cc/90XySb7h/4091.jpg" alt="" /> <p>Webname</p></div>
