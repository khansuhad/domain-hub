                ...
                <tr>
                  ...
                  <td className="p-4  flex items-center gap-3">
                    {users?.approve == "Accepted" && (
                      <p className="block cursor-pointer text-black text-center lg:text-xl lg:font-semibold bg-green-400 p-2 rounded-sm font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                        Accepted
                      </p>
                    )}
...
=======
                    {users?.approve == "Pending" && (
                      <p className="block  font-sans text-sm text-center text-black lg:text-xl lg:font-semibold bg-yellow-300 p-2 rounded-sm antialiased font-normal leading-normal text-blue-gray-900">
                        Pending
                      </p>
                    )}
>>>>>>> 45d40c11ac79a532f50c7ff8f3ecdcc0292cf0c7

                    {users?.approve == "Rejected" && (
                      <p className="block cursor-pointer text-black text-center lg:text-xl lg:font-semibold bg-red-400 p-2 rounded-sm  font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                        Rejected
                      </p>
                    )}
                  </td>
                    ...
                    <>
                      <td className="p-4 border-b border-blue-gray-50  items-center gap-3">
                        <p
                          ...
                          className="flex justify-center items-center gap-3 lg:w-[50%]  cursor-pointer text-black text-center lg:text-xl lg:font-semibold bg-secondColor p-2 rounded-sm   font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900"
                        >
                          {users?.claimDomain}
                        </p>
                      </td>
                      <td className="p-4 border-b border-blue-gray-50 w-[300px] mx-auto items-center gap-3">
                        <p
                          data-ripple-dark="true"
                          className="flex  justify-center items-center gap-3 cursor-pointer text-black  lg:text-xl lg:font-semibold  bg-secondColor p-2 rounded-sm   font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900"
                        >
                          <FreeTrialCountDown
                            trialDate={users?.claimDate}
                          ></FreeTrialCountDown>
                        </p>
                      </td>
                    </>
                    ...
                    <td className="p-4 border-b border-blue-gray-50  items-center gap-3">
                      {users?.approve == "Accepted" && (
                        <p
                          data-ripple-dark="true"
                          onClick={() => {
                            handleDetails(users?.domainName);
                          }}
                          className="flex items-center gap-3 lg:w-[50%] cursor-pointer text-black text-center lg:text-xl lg:font-semibold bg-secondColor p-2 rounded-sm hover:bg-thirdColor  font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900"
                        >
                          Claim <IoDiamond></IoDiamond>
                        </p>
                      )}
