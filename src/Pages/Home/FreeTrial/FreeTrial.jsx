    ...
    return (
        ...
        <>
            ...
            <section  className="flex lg:flex-row flex-col items-center justify-between  rounded-md dark:bg-[#191919] lg:px-[15%]  lg:h-[600px]">
                <div className="lg:w-[750px] space-y-10 delay-200"  data-aos="zoom-in"   >
                    <img src={image} alt="" />
                </div>
                
                <div className=" h-screen flex items-center justify-center text-white">

                    <div className="max-w-md p-8 dark:bg-gray-700 bg-fourthColor shadow-md rounded-md delay-200"  data-aos="zoom-in" >
