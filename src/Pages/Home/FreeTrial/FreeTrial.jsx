...
const FreeTrial = () => {
    return (
        ...
        <>
            ...
            <section className="flex lg:flex-row flex-col items-center justify-between lg:bg-slate-100 lg:px-[15%]  lg:h-[600px]">
                ...
                <div className=" h-screen flex items-center justify-center">
                    ...
                    <div className="max-w-md p-8 bg-white shadow-md rounded-md">
                        ...
                        <form className="mb-4 ">
                            <label className=" text-gray-700 text-sm font-semibold mb-2 flex items-center gap-1"><MdEmail></MdEmail>Email Address</label>
                        ...
                        <p className="text-gray-700 mb-4 text-[12px] font-thin ">
